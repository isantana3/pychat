...
from tkinter import Tk, Label, LEFT, END, Frame, Canvas, Scrollbar, Entry, FLAT, RIGHT
...
def set_user(username):
    ...
    """
    user = username
    Label(frame_side, text=username, wraplength=20, anchor="w", justify=LEFT).pack()
...
def start_screen():
    ...
    # TITULO - PRINCIPAL
    label = Label(win, text="Redes - pychat", font="Helvetica 16 bold italic")

    # TITULO - LADO
    label_side = Label(
        frame_side, text="Usuários", font="Helvetica 10 bold italic", justify='left'
    )
    ...
    # MENSAGEM
    entry = Entry(
        win, width='85', borderwidth=18, bg='#ccc', relief=FLAT, font='Times 10'
    )
